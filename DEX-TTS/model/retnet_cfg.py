...
class RetNetConfig(PretrainedConfig):
    ...
    activation_dropout: float = 0.1  # dropout probability after activation in FFN.
    drop_path_rate: float = 0.1
    decoder_embed_dim: int = 1024  # decoder embedding dimension
    decoder_value_embed_dim: int = 1024  # decoder value embedding dimension
    decoder_ffn_embed_dim: int = 1024  # decoder embedding dimension for FFN
    decoder_layers: int = 8  # num decoder layers
    decoder_retention_heads: int = 4  # num decoder retention heads
